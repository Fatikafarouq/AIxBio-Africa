...
const FAQS = [
  ...
  {q:"Who is eligible to apply?",a:"Early-career researchers based in Africa, or working on Africa-relevant biosecurity research. We welcome masters students, PhD students, early postdocs, and practitioners. No prior biosecurity research experience is required, but genuine interest in the field is essential."},
  {q:"Is there a cost to participate?",a:"The programme is offered at no cost to accepted fellows. Details of any additional support available to participants will be confirmed and communicated when formal applications open in 2026."},
  {q:"What are the expected outputs?",a:"By the end of the programme, each fellow is expected to have produced a short research memo on a biosecurity topic of their choosing, participated in all scheduled sessions, and presented their work to the cohort."},
  {q:"Can I apply if I am not based in Africa?",a:"The fellowship is designed for African researchers or those working on African biosecurity contexts. Applicants from outside Africa whose work is directly relevant may be considered on a case-by-case basis."},
  {q:"When will applications open?",a:"We expect to open formal applications in early 2026. Submitting an expression of interest ensures you will be notified when applications open."},
  {q:"What disciplines are relevant?",a:"We welcome researchers from life sciences, veterinary medicine, public health, computational biology, computer science, policy, and related fields. The common thread is an interest in biosecurity and AI."},
  {q:"How competitive is admission?",a:"The first cohort will be small to ensure mentorship quality. We particularly encourage applications from researchers from underrepresented backgrounds in biosecurity science."},
];
...
const HomeFellowship = ({ go }) => (
  <Sec bg="#fff" id="fellowship">
    <div className="g2" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:72,alignItems:"center" }}>
      <div className="reveal">
        <Ey label="Fellowship"/>
        <H2 s={{ marginBottom:20 }}>5-Week Research Fellowship</H2>
        <Txt s={{ marginBottom:16 }}>The AIxbio Africa Research Fellowship is a research-focused programme for early-career African scientists working at the intersection of biosecurity, AI, and emerging technology governance. The first cohort launches in 2026.</Txt>
        <Txt muted s={{ marginBottom:28, fontSize:14.5 }}>Fellows engage with foundational concepts, develop practical research skills, and receive mentorship from practitioners in biosecurity and related fields. The programme is offered at no cost to participants. Full details will be published when applications open.</Txt>
        <div style={{ display:"flex",gap:12,flexWrap:"wrap" }}>
          <button className="br" onClick={() => go("apply")}>Express Interest</button>
          <button className="bo" onClick={() => go("fellowship")}>Programme Details →</button>
        </div>
      </div>
      <div style={{ display:"flex",flexDirection:"column",gap:16 }}>
        {[["Biosecurity Foundations","Biological risks, zoonotic disease, dual-use research, and international governance frameworks."],["AI and Emerging Technologies","How advanced technologies interact with life sciences, research methods, and risk assessment."],["African Contexts","Biosecurity challenges specific to African settings, indigenous knowledge, and policy landscape."],["Research and Communication","Developing research questions, evaluating evidence, and communicating findings to policy audiences."]].map(([title,desc],i) => (
...
const FellowshipPage = ({ go, addApp, startTab = "overview" }) => {
  ...
  return (<>
    <PageHdr label="Fellowship" title="Research Fellowship" sub="An interdisciplinary programme for early-career African researchers working at the intersection of biosecurity, AI, and emerging technology governance. Launching 2026."/>
      ...
      <Sec bg="#fff">
        <div className="g2" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:72 }}>
          <div className="reveal">
            ...
            <Txt s={{ marginBottom:14 }}>The AIxbio Africa Fellowship is a research-focused programme designed to introduce emerging African researchers to key challenges at the intersection of biosecurity, artificial intelligence, and emerging technology governance.</Txt>
            <Txt s={{ marginBottom:14 }}>Participants will engage with foundational concepts, explore current research questions, and develop practical skills in literature review, risk analysis, evaluation methodologies, and research communication. The fellowship emphasises critical thinking, interdisciplinary collaboration, and responsible approaches to high-impact technologies.</Txt>
            <Txt muted s={{ marginBottom:28, fontSize:14.5 }}>The programme is intended as an entry point for individuals interested in contributing to research and policy discussions surrounding advanced technologies and biological risks. It is offered at no cost to accepted participants. Full details will be published when applications formally open.</Txt>
            <button className="br" onClick={() => setTab("apply")}>Express Interest →</button>
          </div>
          <div>
            {[["Research-focused","Participants develop practical research skills through guided inquiry, not passive instruction."],
              ["Interdisciplinary","The programme welcomes backgrounds across life sciences, technology, policy, and social sciences."],
              ["Mentored","Participants work with mentors drawn from biosecurity, AI, and related fields."],
              ["No cost to participants","The programme is offered at no charge to all accepted fellows. Details of any additional support will be confirmed before the 2026 launch."]
            ].map(([t,d],i)=>(
              <div key={t} className={`reveal d${i+1}`} style={{ display:"flex",gap:20,padding:"22px 0",borderBottom:i<3?"1px solid var(--brd)":"none" }}>
                <div style={{ width:7,height:7,borderRadius:"50%",background:"#B8102A",marginTop:7,flexShrink:0 }}/>
                <div>
                  <div style={{ fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:600,color:"#1A1917",marginBottom:5 }}>{t}</div>
                  <Txt muted s={{ fontSize:14.5 }}>{d}</Txt>
                </div>
              </div>
            ))}
      ...
      <Sec bg="#fff">
        <div className="g2" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:72 }}>
          <div className="reveal">
            ...
            <Txt s={{ marginBottom:16 }}>Applications are open to individuals based in Africa who demonstrate strong intellectual curiosity and an interest in biosecurity, AI, public health, biotechnology, policy, or related fields.</Txt>
            <Txt s={{ marginBottom:28 }}>Previous experience in biosecurity or AI is not required. We welcome applicants who are eager to learn, engage critically with emerging risks, and contribute to thoughtful research and discussion.</Txt>
            <div style={{ marginBottom:12 }}>
              <div style={{ fontFamily:"'Figtree',sans-serif",fontSize:10.5,fontWeight:700,color:"#5A5956",letterSpacing:".12em",textTransform:"uppercase",marginBottom:14 }}>Relevant backgrounds include</div>
              {["Biological and health sciences","Veterinary medicine","Computer science and engineering","Public policy and governance","Social sciences and humanities","Other disciplines with an interest in biological or technological risk"].map((t,i)=>(
                <div key={i} style={{ display:"flex",gap:10,padding:"9px 0",borderBottom:"1px solid var(--brd)" }}>
          ...
          <div className="reveal d2">
            <div style={{ background:"#F7F6F2",border:"1px solid var(--brd)",padding:"28px 24px",marginBottom:16 }}>
              ...
              {["Demonstrated interest in biosecurity, AI, or emerging technology governance","Analytical ability and genuine intellectual curiosity","Motivation to engage seriously with complex, high-stakes topics","Commitment to completing the programme","Capacity to work independently in a remote setting"].map((t,i)=>(
            ...
            <div style={{ border:"1px solid var(--brd)",padding:"20px 22px" }}>
              <h4 style={{ fontFamily:"'Figtree',sans-serif",fontSize:11,fontWeight:700,color:"#5A5956",letterSpacing:".12em",textTransform:"uppercase",marginBottom:12 }}>Selection criteria</h4>
              <Txt muted s={{ fontSize:13.5 }}>Selection will be based on demonstrated interest, motivation, analytical ability, and commitment to the programme. No prior research experience in AI safety or biosecurity is required.</Txt>
            </div>
          </div>
        </div>
      </Sec>
      ...
      <Sec bg="#fff">
        {done ? (
          <div style={{ maxWidth:520,margin:"0 auto",textAlign:"center",padding:"40px 0" }}>
            <div style={{ width:48,height:48,borderRadius:"50%",background:"rgba(26,118,70,.1)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px",fontSize:22 }}>✓</div>
            <h3 style={{ fontFamily:"'Cormorant Garamond',serif",fontSize:28,fontWeight:600,color:"#1A1917",marginBottom:10 }}>Expression of Interest Received</h3>
            <Txt muted s={{ marginBottom:24 }}>Thank you, {fd.name}. We have recorded your interest. You will be contacted when applications formally open in 2026.</Txt>
            <button className="bo" onClick={() => { setDone(false); setStep(1); setTab("overview"); go("home"); }}>Return to Homepage</button>
          </div>
        ) : (
          <div style={{ maxWidth:680 }}>
            <div style={{ marginBottom:32 }}>
              <Ey label="Expression of Interest"/>
              <H2 s={{ marginBottom:8 }}>Apply for the Fellowship</H2>
              <Txt muted s={{ fontSize:14.5 }}>Applications will open in 2026. This form registers your interest and ensures you are notified when we open formal applications.</Txt>
            </div>
            {/* Step indicator */}
            <div style={{ display:"flex",alignItems:"center",gap:8,marginBottom:36 }}>
              {[1,2,3,4].map(s => (<>
                <div key={s} className="step-dot"
                  style={{
                    background: s<step ? "#B8102A" : s===step ? "#B8102A" : "transparent",
                    color: s<=step ? "#fff" : "#9A9896",
                    border: s<=step ? "none" : "1.5px solid var(--brd2)",
                  }}>{s<step ? "✓" : s}</div>
                {s<4 && <div style={{ flex:1,height:1.5,background: s<step ? "#B8102A" : "var(--brd)" }}/>}
              </>))}
            </div>
            <div style={{ fontFamily:"'Figtree',sans-serif",fontSize:11,color:"#9A9896",letterSpacing:".06em",textTransform:"uppercase",marginBottom:20 }}>
              {["Personal Information","Research Background","Statement of Interest","Review & Submit"][step-1]}
            </div>

            {step===1 && (
              <div>
                <div className="g2" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:16 }}>
                  <FF label="Full Name" error={errs.name}><input value={fd.name} onChange={upd("name")} placeholder="Your full name"/></FF>
                  <FF label="Email Address" error={errs.email}><input type="email" value={fd.email} onChange={upd("email")} placeholder="your@email.com"/></FF>
                  <FF label="Country of Residence" error={errs.country}><input value={fd.country} onChange={upd("country")} placeholder="Country"/></FF>
                  <FF label="Institution / Affiliation"><input value={fd.institution} onChange={upd("institution")} placeholder="University, organization, or independent"/></FF>
                </div>
              </div>
            )}
            ...
            {step===2 && (
              <div>
                <div className="g2" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:16 }}>
                  <FF label="Career Stage" error={errs.stage}>
                    <select value={fd.stage} onChange={upd("stage")}>
                      <option value="">Select stage</option>
                      {["Masters student","PhD student","Early postdoc (0–5 yrs)","Established researcher","Practitioner / Other"].map(o=><option key={o}>{o}</option>)}
                    </select>
                  </FF>
                  <FF label="Primary Area of Interest" error={errs.area}>
                    <select value={fd.area} onChange={upd("area")}>
                      <option value="">Select area</option>
                      {RESEARCH.map(r=><option key={r.slug}>{r.title}</option>)}
                    </select>
                  </FF>
                </div>
                <FF label="Research Background" error={errs.background}><textarea value={fd.background} onChange={upd("background")} placeholder="Briefly describe your academic or professional background. What have you been working on? (2–4 sentences)"/></FF>
              </div>
            )}

            {step===3 && (
              <div>
                <FF label="Statement of Interest" error={errs.statement}><textarea value={fd.statement} onChange={upd("statement")} style={{ minHeight:130 }} placeholder="Why are you interested in AI safety and biosecurity research? What draws you to this programme? (100–300 words)"/></FF>
                <FF label="Research Question of Interest" error={errs.question}><textarea value={fd.question} onChange={upd("question")} placeholder="Describe a biosecurity or AI safety research question you find interesting or would like to explore during the fellowship."/></FF>
                <FF label="Reference Name (optional)"><input value={fd.ref1name} onChange={upd("ref1name")} placeholder="Name of a professional reference"/></FF>
                <FF label="Reference Email (optional)"><input value={fd.ref1email} onChange={upd("ref1email")} placeholder="Reference email address"/></FF>
              </div>
            )}

            {step===4 && (
              <div>
                <div style={{ background:"#F7F6F2",border:"1px solid var(--brd)",padding:"22px 24px",marginBottom:20 }}>
                  <h4 style={{ fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:600,color:"#1A1917",marginBottom:14 }}>Review your application</h4>
                  {[["Name",fd.name],["Email",fd.email],["Country",fd.country],["Institution",fd.institution||"—"],["Stage",fd.stage],["Area",fd.area]].map(([l,v])=>(
                    <div key={l} style={{ display:"flex",gap:16,padding:"8px 0",borderBottom:"1px solid var(--brd)" }}>
                      <span style={{ fontFamily:"'Figtree',sans-serif",fontSize:12,fontWeight:600,color:"#5A5956",letterSpacing:".04em",textTransform:"uppercase",width:100,flexShrink:0 }}>{l}</span>
                      <span style={{ fontFamily:"'Figtree',sans-serif",fontSize:13.5,color:"#1A1917" }}>{v}</span>
                    </div>
                  ))}
                </div>
                <FF label="" error={errs.terms}>
                  <label style={{ display:"flex",alignItems:"flex-start",gap:10,cursor:"pointer" }}>
                    <input type="checkbox" checked={fd.terms} onChange={upd("terms")} style={{ width:"auto",marginTop:2 }}/>
                    <Txt muted s={{ fontSize:13.5,lineHeight:1.6 }}>I confirm that I have read the programme details and that the information I have provided is accurate. I understand this is an expression of interest and not a formal application.</Txt>
                  </label>
                </FF>
              </div>
            )}
            ...
            <div style={{ display:"flex",gap:12,marginTop:24 }}>
              {step>1 && <button className="bo" onClick={()=>{setStep(s=>s-1);setErrs({});}}>← Back</button>}
              {step<4 && <button className="br" onClick={next}>Continue →</button>}
              {step===4 && <button className="br" onClick={submit} disabled={submitting}>{submitting?"Submitting…":"Submit Expression of Interest"}</button>}
              {step>1 && <span style={{ fontFamily:"'Figtree',sans-serif",fontSize:12,color:"#9A9896",alignSelf:"center" }}>Progress saved</span>}
            </div>
          </div>
        )}
      </Sec>
    ...
    <Sec bg="#F7F6F2" style={{ padding:"44px 44px" }}>
      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16 }}>
        <div><h4 style={{ fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:600,color:"#1A1917",marginBottom:4 }}>Questions about the fellowship?</h4><Txt muted s={{ fontSize:14.5 }}>We respond to fellowship questions within 3–5 working days.</Txt></div>
  ...
  <footer style={{ background:"#1C1B18",padding:"64px 44px 36px",position:"relative",overflow:"hidden" }}>
    ...
    <div style={{ maxWidth:1160,margin:"0 auto",position:"relative",zIndex:2 }}>
      <div className="fg" style={{ display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:48,marginBottom:48 }}>
        ...
        {[{t:"Research",ls:[["Research","research"],["About","about"],["Blog","blog"]]},{t:"Fellowship",ls:[["Overview","fellowship"],["Mentors","mentors"],["Apply","apply"]]},{t:"Organisation",ls:[["Contact","contact"],["Collaborate","collaborate"],["Donate","donate"]]}].map(({t,ls})=>(
          <div key={t}>
