...
const AdminDashboard=({go})=>{
  ...
  const [fellowForm,setFellowForm]=useState(EMPTY_FELLOW_FORM); const [fellowPhotoFile,setFellowPhotoFile]=useState(null); const [fellowSaving,setFellowSaving]=useState(false);
